...
const HospitalDashboard: React.FC = () => {
  ...
  // Hospital staff can request blood and initiate transfers
  const quickActions = [
    { id: 1, title: 'New Blood Request', icon: '🩸', route: ROUTES.newRequest, color: '#FF5252' },
    { id: 2, title: 'New Transfer Request', icon: '📤', route: ROUTES.transferRequest, color: '#2196F3' },
    { id: 3, title: 'Track Orders', icon: '📋', route: ROUTES.orderTracking, color: '#4CAF50' },
    { id: 4, title: 'Transfer Status', icon: '🚚', route: ROUTES.transferStatus, color: '#FF9800' },
    { id: 5, title: 'View Inventory', icon: '📦', route: ROUTES.inventory, color: '#9C27B0' },
  ...
  return (
    <ProtectedLayout>
      <PageHeader
        ...
        description="Welcome, Hospital Staff! Request blood, initiate transfers, track orders, and manage your inventory."
      />
